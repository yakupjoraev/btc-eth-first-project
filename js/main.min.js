...
const TRANS_AMOUNT_DEFAULT = 104642;
...
const generateAddress = () => `bc${randomInteger(1, 2) == 1 ? "1" : "3"}${makeid(4)}...`;
...
class TableRecord{
    constructor(offset_seconds = 0){
        ...
        this.ValueCell = new TableCell(`${this.Value[0]} BTC<br>${this.Value[1]} BTC`, "Value");
